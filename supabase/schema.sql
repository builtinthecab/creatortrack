...
-- ──────────────────────────────────────────────────────────────
-- PLATFORM_CONNECTIONS  (OAuth tokens for Gumroad & YouTube)
-- ──────────────────────────────────────────────────────────────
...
-- Client can read connection status (username, last_synced_at) but never tokens
...
-- Inserts and updates go through server-side API routes (service role bypasses RLS)
